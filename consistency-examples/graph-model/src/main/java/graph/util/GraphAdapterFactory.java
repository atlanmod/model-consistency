...
public class GraphAdapterFactory extends AdapterFactoryImpl {
	...
	protected GraphSwitch<Adapter> modelSwitch =
		new GraphSwitch<Adapter>() {
			...
			@Override
			public Adapter caseMultiValuesExample(MultiValuesExample object) {
				return createMultiValuesExampleAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link graph.Vertex <em>Vertex</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link graph.MultiValuesExample <em>Multi Values Example</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMultiValuesExampleAdapter() {
		return null;
	}
